...
-- Copiando estrutura do banco de dados para bglandia_v2
CREATE DATABASE IF NOT EXISTS `bglandia_v2` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci */;
USE `bglandia_v2`;

-- Copiando estrutura para tabela bglandia_v2.error_log
...
-- Copiando estrutura para tabela bglandia_v2.user
...
-- Copiando estrutura para tabela bglandia_v2.user_roles
